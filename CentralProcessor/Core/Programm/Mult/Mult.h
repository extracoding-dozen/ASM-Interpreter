...
class Mult : public Command <RegisterBlock&, VariableMemory&, std::string&, std::string&>, public CommandConcretic{
public:
    void whatToDo(RegisterBlock & rb, VariableMemory & wm, std::string& operand1, std::string& operand2) override {
        ...
        if (oper1d == 0 && oper2d == 0) {
            if (oper2i != 0 && oper1i > INT64_MAX / oper2i || oper1i < INT64_MIN /oper2i) {
